...
import { Button, Input, Link, Checkbox, Card, CardBody } from "@nextui-org/react";
  ...
  return (
    <div className="flex w-full max-w-sm flex-col items-center gap-4 p-4">
      <div className="w-full text-left">
        ...
        <p className="text-small text-default-500">Inscrivez-vous pour commencer</p>
      </div>

      {message && (
        <Card>
          <CardBody>
            <p className={message.includes("erreur") ? "text-danger" : "text-success"}>
              {message}
            </p>
          </CardBody>
        </Card>
